            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                <div className="flex -space-x-2">
                  <Image className="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src={avatar9} alt="Image Description" />
                  <Image className="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src={avatar8} alt="Image Description" />
                  <Image className="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src={avatar7} alt="Image Description" />
                  <Image className="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src={avatar6} alt="Image Description" />
                </div>
              </div>
            </div>
          </div>
