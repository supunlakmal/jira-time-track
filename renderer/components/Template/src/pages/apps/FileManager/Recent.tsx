                        ...
                        return (
                          <tr key={idx}>
                            <td className="p-3.5 text-sm text-gray-700 dark:text-gray-400">
                              <Link href="#" className="font-medium">{file.name}</Link>
                            </td>
                            <td className="p-3.5 text-sm text-gray-700 dark:text-gray-400">
                            ...
                            <td className="p-3.5">
                              <div className="flex -space-x-1.5">
                                {(file.members || []).map((member, idx) => (
                                  <Image key={idx} className="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src={member.image} alt="Image Description" />
                                ))}
                              </div>
                            </td>
                            <td className="p-3.5">
