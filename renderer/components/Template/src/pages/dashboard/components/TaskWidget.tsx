    ...
    <div className="card">
      <div className="p-6">
        ...
        <div className="flex items-end">
          ...
          <div className="flex">
            <a href="">
              <Image src={props.avatar1} className="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend" />
            </a>
            <a href="" className="-ms-2">
              <Image src={props.avatar2} className="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend" />
            </a>
          </div>
        </div>
      </div>
