    ...
    <>
      <div className="p-5">
        <div className="relative">
          ...
          <PopoverLayout placement="bottom" togglerClass="btn inline-flex justify-center items-center bg-primary text-white w-full" toggler={<PopoverToggler />}>
            <div className="w-full min-w-[216px] mt-1 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
              <Link className="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" href="#">
        ...
        <div className="space-y-2 mt-4">
          <Link href="#" className="flex items-center py-2 px-4 text-sm rounded text-gray-500 bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:bg-gray-700 dark:hover:text-gray-300" id="headingOne">
            <i className="mgc_home_3_line text-lg me-3.5 w-4"></i>
            <span>Home</span>
          </Link>
          <Link href="#" className="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300" id="headingOne">
