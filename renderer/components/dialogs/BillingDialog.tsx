...
export const BillingDialog: React.FC<BillingDialogProps> = ({ onClose }) => {
  ...
  const footerContent = (
    <div className="flex justify-end space-x-3">
      <Button type="button" onClick={onClose} variant="gray" size="md">
        Close
      </Button>
      {activeTab === "settings" && (
        <Button
  ...
  if (loading) {
    return (
      <ModalWrapper onClose={onClose} title="Billing Management" size="xl" footer={footerContent}>
