        ...
        <div className="h-screen w-screen flex justify-center items-center">
          <div className="flex flex-col justify-center text-center gap-6">
            <Link href="/" className="flex justify-center mx-auto">
              <Image className="h-6 block dark:hidden" src={logoDark} alt="" />
              <Image className="h-6 hidden dark:block" src={logoLight} alt="" />
            </Link>
            ...
            <Link href="/" className="text-base font-medium text-primary"> Go back home </Link>
          </div>
        </div>
      </div>
    </>
