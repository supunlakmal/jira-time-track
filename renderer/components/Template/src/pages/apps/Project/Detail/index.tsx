        ...
        <div className="p-6">
          <div>
            ...
            <div className="grid grid-cols-4 gap-6">
              <div>
                <div>
                  <p className="mb-3 text-sm uppercase font-medium">
                    <i className="uil-calender text-red-500 text-base"></i>{" "}
                    Start Date
                  </p>
                  <h5 className="text-base text-gray-700 dark:text-gray-300 font-medium">
                    15 July, 2019
                  </h5>
                </div>
              </div>
              <div>
                <p className="mb-3 text-sm uppercase font-medium">
                  <i className="uil-calendar-slash text-red-500 text-base"></i>{" "}
                  Due Date
                </p>
                <h5 className="text-base text-gray-700 dark:text-gray-300 font-medium">
                  21 Nov, 2020
              ...
              <div>
                <p className="mb-3 text-sm uppercase font-medium">
                  <i className="uil-dollar-alt text-red-500 text-base"></i>{" "}
                  Budget
                </p>
                <h5 className="text-base text-gray-700 dark:text-gray-300 font-medium">
                  $13,250
              ...
              <div>
                <p className="mb-3 text-sm uppercase font-medium">
                  <i className="uil-user text-red-500 text-base"></i> Owner
                </p>
                <h5 className="text-base text-gray-700 dark:text-gray-300 font-medium">
                  Rick Perry
                </h5>
            ...
            <div className="mt-6">
              <h6 className="text-sm text-gray-800 font-medium mb-3">
                Assign To
              </h6>
              ...
              <div className="grid md:grid-cols-4 gap-3">
                {(aboutProjects || []).slice(0, 2).map((project, idx) => {
                  return (
                    <div
                      key={idx}
                      className="p-2 border border-gray-200 dark:border-gray-700 rounded mb-2"
                    >
  ...
  return (
    <>
      <PageBreadcrumb
        ...
        breadCrumbItems={["Konrix", "Project", "Project Detail"]}
      />
