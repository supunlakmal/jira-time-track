              ...
              <div className="p-6">
                  ...
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-4 mb-6">
                      <Link href="/" className="block">
                        <Image className="h-6 block dark:hidden" src={logoDark.src} alt="" />
                        <Image className="h-6 hidden dark:block" src={logoLight.src} alt="" />
                      </Link>
                      <h4 className="text-slate-900 dark:text-slate-200/50 font-semibold">Hi ! Adam </h4>
                    </div>
                    <Image src={userImage} alt="user-image" className="h-16 w-16 rounded-full shadow" />
                  </div>
                ) : (
                ...
                {hasThirdPartyLogin &&
                  <div className="flex gap-4 justify-center mb-6">
                    <Link href="https://github.com/" target="_blank" className="btn border-light text-gray-400 dark:border-slate-700">
                      <span className="flex justify-center items-center gap-2">
                        <i className="mgc_github_line text-info text-xl"></i>
                        <span className="lg:block hidden">Github</span>
                      </span>
                    </Link>
                    <Link href="https://www.google.com/" className="btn border-light text-gray-400 dark:border-slate-700">
                      <span className="flex justify-center items-center gap-2">
                        <i className="mgc_google_line text-danger text-xl"></i>
                        <span className="lg:block hidden">Google</span>
                      </span>
                    </Link>
                    <Link href="https://www.facebook.com/" className="btn border-light text-gray-400 dark:border-slate-700">
                      <span className="flex justify-center items-center gap-2">
